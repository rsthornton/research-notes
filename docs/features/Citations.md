...
Citation parsing is a functionality of the [[operations/public-notes/quartz/docs/plugins/Citations|Citation]] plugin. **This plugin is not enabled by default**. See the plugin page for customization options.
