...
A good example of a transformer plugin that borrows from the `remark` and `rehype` ecosystems is the [[operations/public-notes/quartz/docs/plugins/Latex|Latex]] plugin:
