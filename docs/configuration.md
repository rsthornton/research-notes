...
For example, the [[operations/public-notes/quartz/docs/plugins/Latex|Latex]] plugin allows you to pass in a field specifying the `renderEngine` to choose between Katex and MathJax.
...
You can see a list of all plugins and their configuration options [[operations/public-notes/quartz/docs/tags/plugin|here]].
